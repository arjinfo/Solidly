...
export interface VeDistTestInterface extends utils.Interface {
  contractName: "VeDistTest";
  functions: {
...
export interface VeDistTest extends BaseContract {
  contractName: "VeDistTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeDistTestInterface;
