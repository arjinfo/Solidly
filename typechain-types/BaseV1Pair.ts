...
export interface BaseV1PairInterface extends utils.Interface {
  contractName: "BaseV1Pair";
  functions: {
    ...
    "claimFeesFor(address)": FunctionFragment;
...
export interface BaseV1Pair extends BaseContract {
  contractName: "BaseV1Pair";
